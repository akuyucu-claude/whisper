...
const PLACE_TEMPLATES = [
  {
    ...
    whisperMessage:
      "There's a small roastery nearby. The kind with no sign — just the smell of fresh beans pulling you in.",
  ...
  },
  {
    ...
    whisperMessage:
      "You've slowed down near a vinyl shop. No website, no Instagram — just crates and crates of records from people who know.",
  ...
  },
  {
    ...
    whisperMessage:
      "That bakery on the corner has been here longer than anything else on this street. The locals come before 9am — you're just in time.",
  ...
  },
  {
    ...
    whisperMessage:
      "There's a second-hand bookshop a minute away. Ceiling-high shelves, a cat on the counter, and a section of books the owner refuses to sell.",
  ...
  },
  {
    ...
    meta: 'Garden · Public',
    whisperMessage:
      "There's a garden behind that wall you just passed. Most people walk right by it. The entrance is through the iron gate on the left.",
  ...
  },
  {
    ...
    whisperMessage:
      "Fifty metres ahead — a natural wine bar that doesn't advertise. They pour wines from producers you can't find online.",
  ...
  },
  {
    ...
    whisperMessage:
      "That narrow door leads to a gallery showing three artists you've never heard of — and probably should have.",
  ...
  },
  {
    ...
    whisperMessage:
      "There's a family restaurant around the corner. No menu — they cook what's fresh that day. The kind of place that doesn't need a sign.",
